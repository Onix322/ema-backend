...
import java.util.UUID;
    ...
    public boolean equals(Object o) {
        ...
        Car car = (Car) o;
        return Objects.equals(getUuid(), car.getUuid()) && Objects.equals(getNumberPlate(), car.getNumberPlate()) && Objects.equals(getVin(), car.getVin()) && Objects.equals(getManufacturer(), car.getManufacturer()) && getCarState() == car.getCarState() && Objects.equals(getEmployee(), car.getEmployee());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getUuid(), getNumberPlate(), getVin(), getManufacturer(), getCarState(), getEmployee());
    }
